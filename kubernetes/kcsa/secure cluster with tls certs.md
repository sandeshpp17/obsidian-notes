...
each component has the insecure communication. it essential the make those component talk with each other in secure way by configuring them with tls certificates.
